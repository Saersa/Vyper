...
al("TextLabel",{
Text=au.User.Anonymous and "Anonymous"or au.LocalPlayer.DisplayName or game:GetService("Players").LocalPlayer.DisplayName or "Unknown",
TextSize=17,
ThemeTag={
TextColor3="Text",
},
...
al("TextLabel",{
Text=au.User.Anonymous and"@Anonymous"or au.User.UserName or "@".. game:GetService("Players").LocalPlayer.Name,
TextSize=15,
TextTransparency=.6,
ThemeTag={
TextColor3="Text",
